...
// 你的 CSV 路徑
const csvFile = path.join(__dirname, 'src/data/feng-zhi-zhong.csv');
// 輸出 JSON 路徑
const outputFile = path.join(__dirname, 'src/data/guild_union_rank.json');
...
// 設定每 30 分鐘跑一次
setInterval(updateGuildInfo, 2 * 60 * 60 * 1000);
// 啟動時先跑一次
updateGuildInfo();